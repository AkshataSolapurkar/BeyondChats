          ...
          <div className="flex flex-col gap-6 md:gap-2">
            ...
            <div className="flex flex-col items-center w-full max-w-3xl mx-auto">
              <div className="relative w-full flex justify-center rounded-lg overflow-hidden">
                <div className="relative w-full md:h-[40vh]">
                  <img
...
<div className="w-full  max-w-md space-y-4">
  <h2 className="text-2xl font-semibold text-center text-gray-700">Trainig Chatbot</h2>
  <h2 className="text-lg font-medium text-center text-gray-700">Might take Time wait or continue to the next step</h2>
  <motion.div className="md:w-full w-[50] bg-gray-200 h-2 rounded-full md:m-0 mx-5 overflow-hidden">
    <motion.div
